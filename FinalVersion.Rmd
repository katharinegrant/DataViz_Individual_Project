...
#### Data
The dataset is the same as the one I used for a previous revision and can be found [here](https://github.com/katharinegrant/DataViz_Individual_Project/blob/master/Excel_Sheets/Gun%20death%20and%20ownership%20comb.xlsx). The firearm-related deaths by country data come from [Wikipedia](https://en.wikipedia.org/wiki/List_of_countries_by_firearm-related_death_rate).
